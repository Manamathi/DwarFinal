...
public class _00_Launcher_page1 extends Application
{
	...
	public void start(Stage primaryStage)
	{
		...
		// ORIGINAL-Groesse:
		scene = new Scene(gridPane, 920, 710);
//________________ Komponenten-Initialisierung
		...
		changeDesign = new Text("Design wechseln?");
...
////___________________ Layout-GridPane-Komponenten anbringen __________________
		...
		ColumnConstraints spalte8 = new ColumnConstraints(60);
		ColumnConstraints spalte9 = new ColumnConstraints(60);
		...
		gridPane.getColumnConstraints().addAll(spalte1, spalte2, spalte3, spalte4, spalte5,spalte6, spalte7, spalte8,spalte9);
...
gridPane.add(	changeDesign, 	  		  3, 				8, 				   4, 						1					);
